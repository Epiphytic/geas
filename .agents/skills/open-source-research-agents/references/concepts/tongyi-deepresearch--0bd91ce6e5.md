...
## Untrusted concept description
    ...
    An agentic large language model developed by Tongyi Lab, designed for long-horizon deep information-seeking tasks, with 30.5B total parameters and 3.3B activated per token, supporting ReAct and IterResearch inference paradigms.
