...
for the four choices, snapshots, update and removal behavior. Installing Geas
itself remains optional; use this repository's [installation instructions](#installation)
when you want its CLI.
